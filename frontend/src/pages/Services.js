...
const Services = () => {
  ...
  const content = data.servicesPage.data.attributes.content;

  // Custom components for ReactMarkdown
  const components = {
    h1: ({ children }) => {
      // Convert children to string, handling various possible types
        ...
        <h1 className="title1 servicesTitle">
          ...
          <ServicesLinkWord
            ...
            icon={
              ...
              >
                <path
                  d="M7.00781 17.1816H14.1733M8.43039 20.0618H12.7159"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M7.76809 14.9559C7.76809 12.952 3.96875 12.041 3.96875 7.95543C3.96875 3.86986 7.3003 1.18945 10.5489 1.18945M13.3265 14.956C13.3265 12.952 17.1258 12.041 17.1258 7.95543C17.1258 3.86986 13.7943 1.18945 10.5457 1.18945"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
              </svg>
            ...
            icon={
              ...
              >
                <g clip-path="url(#clip0_2698_30062)">
                  <path
                    d="M16.5742 10.6641C18.9503 12.4003 18.3105 16.0327 17.4424 16.9467"
                    stroke="#006EEB"
                    stroke-width="1.8"
                  />
                  <path
                    d="M12.3902 10.2764L7.83815 14.6734L4.75391 11.4805L15.4795 1.1201L18.5637 4.31306L15.7192 7.05246"
                    stroke="#006EEB"
                    stroke-width="1.8"
                  />
                  <path
                    d="M7.53906 8.79102L10.6233 11.984"
                    stroke="#006EEB"
                    stroke-width="1.8"
                  />
                  <circle
          ...
          <ServicesLinkWord
            ...
            icon={
              ...
              >
                <path
                  d="M11.9477 19.2428H2.12891V2.37891H6.36891V8.72286L13.3503 5.21621V8.72286L20.6187 5.21621V19.2428H16.3788M11.9477 19.2428V13.1221H16.3788V19.2428M11.9477 19.2428H16.3788"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
              </svg>
          ...
          <ServicesLinkWord
            ...
            icon={
              ...
              >
                <path
                  d="M14.2324 6.93748V12.6055M14.2324 12.6055L11.3984 9.77148M14.2324 12.6055L17.0664 9.77148"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M7.64644 8.1875L9.79285 9.42673V11.9052L7.64644 13.1444L5.50002 11.9052V9.42673L7.64644 8.1875Z"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M14.2324 1.98047L16.3788 3.2197V5.69817L14.2324 6.93741L12.086 5.69817V3.2197L14.2324 1.98047Z"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M4.32613 14.1423L6.47254 15.3816V17.86L4.32613 19.0993L2.17971 17.86V15.3816L4.32613 14.1423Z"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M10.9238 14.1426L13.0702 15.3818V17.8603L10.9238 19.0995L8.77736 17.8603V15.3818L10.9238 14.1426Z"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
                <path
                  d="M17.5253 14.1426L19.6718 15.3818V17.8603L17.5253 19.0995L15.3789 17.8603V15.3818L17.5253 14.1426Z"
                  stroke="#006EEB"
                  stroke-width="1.8"
                />
              </svg>
