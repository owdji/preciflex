...
const Hyt = () => {
  ...
  // useGSAP(() => { 
  //   console.log('ON EST LA DEDANT', moduleFluidiqueRef.current)
  //   if (moduleFluidiqueRef.current && moduleFluidiqueRef.current.rotation) {
  ...
  //     gsap.to(moduleFluidiqueForAnimationRef.current.position, {
  //       x: -5,
  //       y: 0,
  //       z: 0,
  //       duration: 5,
  ...
  //     gsap.fromTo(moduleFluidiqueForAnimationRef.current.rotation, {
  //       y: Math.PI * 2,
  //     }, {
  //       y: 0.1,
  //       duration: 5,
  ...
  //   } else {
  //     //trow error
  //     console.log('MODULE FLUIDIQUE REF IS NULL');
  //   }
  // },[moduleFluidiqueForAnimationRef]);  
