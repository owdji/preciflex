...
const TableOfContent = () => {
    ...
    return (
      <div>
        <div className='tableOfContents fixed top-max'>
          {tableOfContents.map((title, index) => (
            <div key={index}>
              <div className='flex flex-row items-center'>
              {title.children.length > 0 && (
                  <svg onClick={() => toggleSubtitles(index)} width="30" height="12" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.2715 0.948303L8.6943 9.52549L0.117112 0.948303L0.891897 0.173518L8.6943 7.97592L16.4967 0.173518L17.2715 0.948303Z" fill="#006EEB"/>
                    </svg>
                )}
                <a
                  className='pToc'
